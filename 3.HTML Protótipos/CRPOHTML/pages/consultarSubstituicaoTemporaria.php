            ...
            <section class="content">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Consultar Substituição Temporária</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div>
							...
							<table id="motivos" class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th>Situação</th>
										<th>Ocupante</th>
										<th>Data de Assunção</th>
										<th>Data de Dispensa</th>
										<th>N° de dias a Pagar</th>
										<th>N° e data do BI Publição</th>
										<th>N° Boletim</th>
										<th></th>
										<th></th>
									</tr>
								...
								<tbody>
									<tr>
										...
										<td>Chefe P1</td>
										<td>Férias</td>
										<td>1º Sgt Marcelo</td>
										<td>22/01/2016</td>
										<td></td>
										<td>29</td>
										<td>BI 012 de 29/01/16</td>
										<th>BI 34/2016</th>
								...
								<tfoot>
									<tr>
										...
										<th>Função Superior Exercida</th>
										<th>Data de Assunção</th>
										<th>Data de Dispensa</th>
										<th>N° de dias a Pagar</th>
										<th>N° e data do BI Publição</th>
