            ...
            <section class="content">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Aprovação Superior</h3>
					</div>
					<form role="form">
						<div class="box-body">
							<div class="row">
						...
						<div class="box-footer">
							<button type="button" class="btn btn-warning" onClick="window.location = 'aprovarIndisponibilidadePorSuperior.php'">Permitir</button>
							<button type="button" class="btn btn-danger" onClick="window.location = 'aprovarIndisponibilidadePorRH.php'">Negar</button>
						</div>
					</form>
				</div>
            </section>
