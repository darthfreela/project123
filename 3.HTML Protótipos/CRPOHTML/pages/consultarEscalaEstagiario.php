            ...
            <section class="content">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Consultar Escala Estagiário</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div>
                            <a href="./cadastroEstagiarios.php"><button class="btn btn-block btn-primary">Novo</button></a>
                        </div>
                        </br>
                        ...
                        <table id="motivos" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Carlos André Antunes</td>
                                    <td>2º semestre</td>
                                    <td>25/12/2016</td>
                                    <td>1487-7/18898-0</td>
                                    <td>15</td>
                                    <td>15</td>
                                    <td>120</td>
