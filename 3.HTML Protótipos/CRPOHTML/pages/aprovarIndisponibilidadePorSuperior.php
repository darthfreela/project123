            ...
            <section class="content">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Aprovar Indisponibilidade</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        </br>
							...
							<table id="motivos" class="table table-bordered table-striped">
								...
								<tbody>
									<tr>
										...
										<td><a class="btn btn-success" href="aprovarIndisponibilidadeVisualicacaoSuperior.php"><i class="fa fa-check-square-o	 "></i>Visualizar</a></td>
									</tr>
									<tr>
										<td>2</td>
										<td>2181597</td>
