...
{
var x;
var r=confirm("Tem certeza que deseja concluir ?");
if (r==true)
  {
  x="window.location = 'aprovarIndisponibilidadePorRH.php'";
  }
else
  {
  x="";
            ...
            <section class="content">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Aprovação Rh</h3>
					</div>
					<form role="form">
						<div class="box-body">
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="motivoIndisponibilidade" placeholder="Afastamento por motivo de saúde" disabled>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-3">
									<div class="form-group">
										<label for="funcaoSuperiorExercida">Função Exercida</label>
										<input type="text" class="form-control" id="funcaoSuperiorExercida" placeholder="MAJ QOEM CH DO EM DO CRPO SERRA" disabled>
									</div>
								</div>		
							...
							<div class="row">
								<div class="col-lg-2">
									<div class="form-group">
										<label for="idFunc">ID Func. Superior</label>
										<select class="form-control" id="idFunc"></select>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label for="nomeServidor">Nome do Superior</label>
										<input type="text" class="form-control" id="nomeServidor" placeholder="José de Souza Tira no Sauro" disabled>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-4">
									<div class="form-group">
										<label for="postoServidor">Posto Grad. Superior</label>
										<input type="text" class="form-control" id="postoServidor" placeholder="Posto Grad." disabled>
									</div>
								</div>													
								<div class="col-lg-4">
									<div class="form-group" style="margin-left:10px;">
										<label for="funcaoSuperiorExercida">Função Exercida Superior</label>
										<input type="text" class="form-control" id="funcaoSuperiorExercida" placeholder="CAP QOEM CHEFE DO P1 " disabled>
									</div>
								</div>								
							</div>
							
							<div class="box-footer">
								<button type="button" class="btn btn-warning" onclick="funcao1()" >Permitir</button>
								<button type="button" class="btn btn-danger" onclick="funcao1()">Negar</button>
							</div>
						</div>
					</div>
				</form>
