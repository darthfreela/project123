            ...
            <section class="content">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title" style="font-size: 32px;margin-left: 40%;margin-top: 20px;">Cadastro de Permissões</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="motivos" class="table table-bordered table-striped" style="width: 800px;">
                            <tbody>
                                <tr>
                                	<td>Tipo do Perfil </td>
                                	<td><select name="perfil">
									  <option value="administrador">Administrador</option>
									  <option value="usuarioprevilegiado">Usuário Previlegiado</option>
