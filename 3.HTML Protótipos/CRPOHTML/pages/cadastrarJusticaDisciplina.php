            ...
            <section class="content">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Cadastros de Justiça e Disciplina</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form">
                            ...
                            <div class="bs-example">
								<div class="form-group col-md-12">
									<div class="form-group col-md-6">
										...
										<textarea type="text"  rows="10"  class="form-control" id="sigla" placeholder="Descricao" required>
										</textarea> 
									</div>									
								</div>
								<div class="col-md-12">
                                    <div class="form-group col-md-2">
                                        <label>Data</label>
                                        <input type="date" placeholder="01/01/2001" class="form-control"/>
                                    </div>
                                </div>
